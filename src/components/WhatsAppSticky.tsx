...
export function WhatsAppSticky() {
  ...
  return (
    <a
      ...
      className="fixed right-4 bottom-4 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-whatsapp text-white shadow-[0_10px_30px_-6px_rgba(37,211,102,0.65)] transition hover:scale-105 active:scale-95 sm:right-6 sm:bottom-6 print:hidden"
    >
